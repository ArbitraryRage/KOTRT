...
public class FinishQuest implements IMessage, IMessageHandler<FinishQuest, IMessage> {
	...
	public FinishQuest(int EntityID, int questID){
	...
	@Override
	public IMessage onMessage(FinishQuest message, MessageContext ctx) {
