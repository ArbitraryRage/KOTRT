...
public class GuiKingdomEntityShopKeeper extends GuiScreen {

	EntityShopKeeper ShopKeeper;
	EntityPlayer Player;
	World World;
	...
	public static final ResourceLocation Background1 = new ResourceLocation("kotrt:textures/gui/container/ShopKeeperGUI.png");
	public static final ResourceLocation Background2 = new ResourceLocation("kotrt:textures/items/goldCoin.png");


	public GuiKingdomEntityShopKeeper(EntityShopKeeper shopKeeper, EntityPlayer player, World world, ShopKeeperItemFormat[] saleItems) {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawModalRectWithCustomSizedTexture(guiX + 56, guiY + 54, 4, 5, 12, 10, 20, 20);
        ...
        this.fontRendererObj.drawString("Welcome to my Shop! Here I sell various", guiX + 155, guiY + 35, 0xffffff); 
        this.fontRendererObj.drawString("goods at different prices.", guiX + 155, guiY + 45, 0xffffff); 
        this.fontRendererObj.drawString("Holding Shift will purchase 16 items", guiX + 155, guiY + 65, 0xffffff); 
        this.fontRendererObj.drawString("Holding Control will purchase 64 items ", guiX + 155, guiY + 75, 0xffffff); 
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		}else if(button.id >= 2)
		{
			...
			if(!this.isCtrlKeyDown() && !this.isShiftKeyDown())
				PacketHandler.INSTANCE.sendToServer(new GiveItemToPlayer(Item.getIdFromItem(this.SaleItems[buttonID].getItem().getItem()), 1,this.SaleItems[buttonID].getCost(), this.SaleItems[buttonID].getItem().getMetadata()));
			
			
			
			if(this.isCtrlKeyDown())
			{
				PacketHandler.INSTANCE.sendToServer(new GiveItemToPlayer(Item.getIdFromItem(this.SaleItems[buttonID].getItem().getItem()), 64,this.SaleItems[buttonID].getCost(), this.SaleItems[buttonID].getItem().getMetadata()));
			}
			
			if(this.isShiftKeyDown())
			{
				PacketHandler.INSTANCE.sendToServer(new GiveItemToPlayer(Item.getIdFromItem(this.SaleItems[buttonID].getItem().getItem()), 16,this.SaleItems[buttonID].getCost(), this.SaleItems[buttonID].getItem().getMetadata()));
			}
